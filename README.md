<img src="https://capsule-render.vercel.app/api?type=venom&color=auto&height=300&section=header&text=Chanyoung%20&fontSize=90" />

👋 Hi everyone! I'm a web developer who is passionate about building user-friendly and visually engaging web applications. 💻 <br>
👀 I enjoy combining creative ideas with practical problem-solving to deliver impactful digital experiences. <br>
🌱 Currently, I'm developing applications with Next.js and TypeScript, while expanding my skills toward full stack development through backend and mobile app technologies. <br>
💞️ I’m eager to collaborate with diverse teams, gain new perspectives, and grow as a developer who bridges technology and real-world needs. 😽
<br/>
<br/>

<h2>💥 Experience </h2>

<ul> <a href = "https://github.com/hanaro7team1"> 시도(Hana SIDO) </a> : 시골과 도시를 연결하는 <a href = "https://sido.topician.com"> 시니어 대상 귀촌 여정 플랫폼</a>. 기획 및 풀스택 개발 <sub>(2025.08 ~ 2025.09)</sub> </ul>
<ul> <a href = "https://github.com/Hanaro-Eureka/HPS"> 하나의 완벽한 비서 </a> : MZ 프리랜서 전용 스마트 금융 비서, 금융 데이터 기반 수입과 소비 분석 서비스. 기획 및 풀스택 개발 <sub>(2025.06 ~ 2025.07)</sub> </ul>
<ul> <a href = "https://github.com/Morak-Team"> 모락(morak) </a> : 가치 있는 소비, 지도에서 손쉽게. <a href = "https://github.com/Morak-Team/Frontend"> 서울 시민을 위한 사회적기업 위치 기반 탐색 서비스</a> 기획 및 FE 파트 담당 <sub>(2025.03 ~ 2025.05)</sub> </ul>
<ul> <a href = "https://github.com/Tool-daruda"> 다루다(daruda) </a> : 툴 사용이 미숙한 사람들을 위한 <a href = "https://www.daruda.site/"> 디지털 툴 소개 웹 사이트</a>  FE 파트 담당 <sub>(2024.12 ~ 2025.02)</sub> </ul>
<ul> <a href = "https://github.com/AND-SOPT-WEB"> AND-SOPT-WEB</a> : <a href = "https://github.com/SOPT-all"> SOPT </a> 35기 웹 파트  <sub>(2024.09 ~ 2025.02)</sub> </ul>
<ul> <a href = "https://github.com/ArtNeplatform"> 아트네(ArtNé) </a> : 예술대 학생들의 작품을 경매하는 <a href = "https://github.com/ArtNeplatform/front"> 웹 서비스 플랫폼 </a>  FE 파트 담당 <sub>(2025.01 ~ 2025.02)</sub> </ul>
<ul> <a href = "https://github.com/Codeitboost-Hongik"> Codeit boost 홍익대학교</a> 1기 Manager : 전체 행사 담당, FE 스터디 리드, 프로젝트 리드  <sub>(2024.02 ~ 2025.02)</sub> </ul>
<ul> <a href = "https://github.com/HAT-Here-And-There"> 여행을 떠나요, 여기저기!</a> :  클라우드 네이티브 기반 여행지 비교 서비스. </a> 기획, 디자인, FE 파트 담당 <sub>(2024.03 ~ 2024.08)</sub> </ul>
<ul> <a href = "https://github.com/HIUMC"> UMC </a> 5기 Challenger : 홍익대 지부 웹 리액트 스터디 리드, 프로젝트 참여  <sub>(2023.09 ~ 2024.02)</sub> </ul>
<hr>
